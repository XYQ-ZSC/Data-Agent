...
public final class MySqlTemplate {
    ...
    public static final String SQL_RENAME_TABLE = "RENAME TABLE %s TO %s";    /** %s = full view name (catalog.view or view, escaped and quoted) */
    ...
    /** %1$s = full table name, %2$s = set clause without SET keyword, %3$s = where clause without WHERE keyword */
    public static final String SQL_UPDATE_TABLE_ROW =
